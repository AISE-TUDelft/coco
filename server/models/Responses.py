...
class NewUserResponse(BaseModel):
    """
    The NewUserResponse class is a Pydantic BaseModel class that defines the structure of a response for
        the new user creation process.
    This response is meant to be used along with the /new_user endpoint as a response to a NewUserRequest.
    """

    user_id: str  # the user id to be used for the next request
